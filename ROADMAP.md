...
- **1090 tests passing offline in ~4.5s; ruff + mypy clean**; thirty-two runnable examples; the VincioBench `reliability` / `cost` / `evals` / `scale` families hold the 1.8 guarantees under CI-gated budgets (159 budgets, 48 SLOs).
