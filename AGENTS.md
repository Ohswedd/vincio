...
vincio/verify         verified reasoning & neuro-symbolic certificates (app.verify_reasoning), runtime behaviour shielding (app.shield / behavior_monitor / use_shield), and verified tool use / program synthesis (app.synthesize_program); deterministic kernels dependency-free, optional SMT / CAS behind vincio[verify]
