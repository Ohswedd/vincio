...
def test_version_and_api_contract():
    assert vincio.__version__ == "7.10.0"
    ...
    # 7.7 is the task-context line: context anchors (a PRD/spec/brand frame kept
    # always-present across a chain of calls via a compact cached brief injected
    # as pinned evidence — `vincio.context.anchors`, `EvidenceItem.pinned`,
    ...
    # generation stays "5.0" while the package advances to 7.10.0.
