...
rollback, and a lifecycle watcher proposes migrations off deprecated models. The arc from here to
**3.0** continues additively: making **documents and images flow *out*** as cited, governed,
eval-gated artifacts (not just in), and closing the improvement loop into **continual, online,
safely-rolled-back self-improvement** — with 2.0 and 3.0 the only breaking windows.
