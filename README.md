...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1497%20passing-2ea44f" alt="1497 tests passing">
...
All thirty-four examples in [`examples/`](examples) run **fully offline** with no API keys. Point them
...
swap-gated distillation, and a served observability plane; and **2.2 proves it on the world's
...
generative-UI streaming. The arc from here to **3.0** continues additively — with 2.0 and 3.0
the only breaking windows.
