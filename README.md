...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1613%20passing-2ea44f" alt="1613 tests passing">
...
```bash
pip install -e ".[dev]"
python -m pytest tests/ -q     # 1613 tests, no network or API keys required
